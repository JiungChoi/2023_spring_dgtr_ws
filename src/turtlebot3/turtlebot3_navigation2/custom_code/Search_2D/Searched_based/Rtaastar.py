...
from Search_2D.Searched_based import env

sys.path.append(os.path.dirname(os.path.abspath(__file__)) +
                "/../../Search_based_Planning/")

from Search_2D.Searched_based import queue, plotting


class RTAAStar:
    def __init__(self, s_start, s_goal, N, heuristic_type, cost_map):
        self.s_start = (47,  28)
        self.s_goal = (60,  60)
    ...
    def run(self):
        ...
        self.searching()
        plot.animation_lrta(self.path, self.visited,
